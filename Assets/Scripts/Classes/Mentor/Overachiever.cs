...
public class Overachiever : Mentor
{
    ...
    public Overachiever(CardEdition edition) : base(MentorName.Overachiever, edition, 9)
    {
        ...
        description = "Mentor gains <b><color=red>X0.25 Mult</color></b> if round cleared in first played hand (<b><color=red>X1 Mult</color></b>)";
    }

    //  Update description with xmult
    public override string GetDescription()
    {
        description = $"Mentor gains <b><color=red>X0.25 Mult</color></b> if round cleared in first played hand (<b><color=red>X{xmult} Mult</color></b>)";
        return description;
    }
