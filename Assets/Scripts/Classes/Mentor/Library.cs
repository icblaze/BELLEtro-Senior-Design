...
public class Library : Mentor
{
    ...
    public Library(CardEdition edition) : base(MentorName.Library, edition, 6)
    {
        ...
        description = "This mentor gains <b><color=red>X0.1 Mult</color></b> when a <color=#008080ff>Textbook</color> is used (<b><color=red>X1 Mult</color></b>)";
    }

    //  This mentor gains X0.1 Mult when a Textbook is used (X1 Mult)
    public override string GetDescription()
    {
        description = $"This mentor gains <b><color=red>X0.1 Mult</color></b> when a <color=#008080ff>Textbook</color> is used (<b><color=red>X{textbookMult} Mult</color></b>)";
        return description;
    }
